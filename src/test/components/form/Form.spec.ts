...
describe("form tests", () => {
    ...
    it('should render a form', async () => {
        ...
        expect(component.shadowRoot?.innerHTML).toBe("<style>\n:host {\n    display: block;    \n}\n\nform {\n    box-sizing: border-box;\n    background-color: violet; \n    position: relative;\n    width: 100%;\n}</style><form><!--_$bm_--><!--_$em_--><!--_$bm_--><!--_$em_--><!--_$bm_--><!--_$em_--><slot label-width=\"50%\" justify-label-content=\"space-evenly\" key=\"form-fields\"></slot><!--_$bm_--><wcl-button key=\"submit-button\" kind=\"primary\" variant=\"contained\">\n           <wcl-localized-text resource-key=\"submit\">Submit</wcl-localized-text>\n           <wcl-icon name=\"box-arrow-right\"></wcl-icon>\n        </wcl-button><!--_$em_--></form>");
    });
