...
describe("RequiredValidator tests", () => {
    ...
    it("RequiredValidator with undefined value should emit a generic validation error message when there is no intlProvider set", () => {
        ...
        expect(validationContext.errors[0]).toEqual('This field is required');
    });
