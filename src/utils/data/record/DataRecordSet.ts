...
// import { CollectionDataProvider } from "../DataProvider";
...
//  */
// export default class DataRecordSet implements CollectionDataProvider {
...
//      * @param newData 
//      */
//     update(oldData: DynamicObject, newData: DynamicObject) {
...
//     commit(callback: (addedRecords: DynamicObject[], modifiedRecords: DynamicObject[], removedRecords: DynamicObject[]) => void) {
